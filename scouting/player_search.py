...
with col_filters:
    ...
    with col_valor_min:
        valor_min_val = st.number_input("Valor Mínimo (M€)", min_value=0, max_value=100000000, value=0, step=100000)
    with col_valor_max:
        valor_max_val = st.number_input("Valor Máximo (M€)", min_value=0, max_value=100000000, value=100000000, step=100000)
